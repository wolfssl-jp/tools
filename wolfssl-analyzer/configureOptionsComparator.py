...
def main():
    try:
        ...
        parser_group.add_argument('--options-file', type=str, help='Text file with options to be executed. '
                            'Cannot be used with --single-option or --opposite-option. '
        ...
        parser_group.add_argument('--single-option', type=str, help='Specify a single option to execute. '
                            'Cannot be used with --options-file or --opposite-option.')
        parser_group.add_argument('--opposite-option', action='store_true', 
        ...
        parser.add_argument('--exclude-options', type=str, help='Text file with options to be excluded from execution.'
                            'If you use --opposite-option, you should exclude both "enable" and "disable" options.')
        ...
        options = []
        configureOptionsExtractor(args.opposite_option)
